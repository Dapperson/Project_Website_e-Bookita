    ...
    <nav data-aos="fade-down" data-aos-duration="1000" class="sb-topnav navbar navbar-expand"
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                if($username == 'admin'){
                ?>
                    <li><a style="color: #800000;" class="dropdown-item" href="manage.php">Pesan</a></li>
                    <?php
                }
                ?>
                    <li>
        ...
        <div id="layoutSidenav_content">
                    ...
                    <div class="container col-xxl-8 px-4 py-5">
                        <div class="row flex-lg-row align-items-center g-5 py-5">
                            <div data-aos="fade-right" data-aos-duration="1000" class="col-lg-5">
                                <img src="upload.png" class="d-block mx-lg-auto img-fluid" alt="Admin" width="500"
                            ...
                            <div data-aos="fade-left" data-aos-duration="1000" class="col-10 col-sm-8 col-lg-6">
                                <h1 data-aos="fade-right" data-aos-duration="1000" style="color: #800000;"
                                    class="display-6 fw-bold lh-1 mb-3"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="40" height="40" fill="currentColor" class="bi bi-file-earmark-arrow-up"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <p data-aos="fade-right" data-aos-duration="1000" class="lead">Silahkan uplaod e-book
                                    anda untuk menambah koleksi ebook kami</p>
                            </div>
            ...
            <main>
                <div data-aos="zoom-out" data-aos-duration="1000" class="container">
                    <div class="card mt-3 border-5 active pb-0 px-3">
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-12 ">
                                    <h2 class="card-title text-start mb-3" style="color:#800000"><b>Upload E-Book</b>
                                    </h2>

                                    <div class="container">
                                        <form class="form-horizontal" action="upload_ebook.php" method="post"
                                            enctype="multipart/form-data">

                                            <div class="form-group" style="color:#800000">
                                                <label class="control-label col-sm-2 mb-2" for="judul">
                                                    <h6>Judul:</h6>
                                                </label>
                                                <fieldset>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control mb-4" id="judul"
                                                            name="judul" required>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="form-group" style="color:#800000">
                                                <label class="control-label col-sm-2 mb-2" for="penulis">
                                                    <h6>Nama Penulis:</h6>
                                                </label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control mb-4" id="penulis"
                                                        name="penulis" required>
                                                </div>
                                            </div>

                                            <div class="form-group" style="color:#800000">
                                                <label class="control-label col-sm-2 mb-2" for="penerbit">
                                                    <h6>Penerbit:</h6>
                                                </label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control mb-4" id="penerbit"
                                                        name="penerbit">
                                                </div>
                                            </div>

                                            <div class="form-group" style="color:#800000">
                                                <label class="control-label col-sm-2 mb-2" for="jenis">
                                                    <h6>Jenis Buku:</h6>
                                                </label>
                                                <select id="jenis" name="jenis" class="form-select  mb-4"
                                                    aria-label="Default select example" required>
                                                    <option selected>Pilih jenis buku</option>
                                                    <option value="Ilmiah">Ilmiah</option>
                                                    <option value="Non-Ilmiah">Non-Ilmiah</option>
                                                </select>
                                            </div>

                                            <div class="form-group" style="color:#800000">
                                                <label class="control-label col-sm-2 mb-2" for="nama_file">
                                                    <h6>Pilih File (PDF):</h6>
                                                </label>
                                                <fieldset>
                                                    <div class="col-sm-12">
                                                        <input type="file" class="form-control mb-4" id="nama_file"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <a class="btn btn-danger" href="ebook.php"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16"
