            ...
            <div data-aos="zoom-out" data-aos-duration="1000" class="card border border-2 m-3">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button style="color: #800000;" class="nav-link active" id="home-tab" data-bs-toggle="tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <button style="color: #800000;" class="nav-link" id="non-ilmiah-tab" data-bs-toggle="tab"
                ...
                ?>
                                                <nav class="navbar">
                                                    <a href="edit_file.php?id_ebook=<?php echo $data['id_ebook'];?>"><svg xmlns="http://www.w3.org/2000/svg"
