...
<head>
    ...
    <title>Edit E-Book - e-Bookita</title>
                    ...
                    <div class="card mt-3 border-5 pt-2 active pb-0 px-3">
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-12 ">
                                    <nav class="navbar">
                                        <h2 class="card-title text-start mb-3" style="color:#800000"><b>Edit E-Book</b>
                                        </h2>
                                    </nav>
                                    ...
                                    if (isset($_GET['id_ebook'])) {
                                        ...
                                        include 'koneksi.php';
                                        $data = mysqli_query($connect,"SELECT * FROM ebook WHERE id_ebook = '$id_ebook'") or die(mysqli_errno($connect));
                                        $baris = mysqli_fetch_array($data); ?>
                                    <div class="container">
                                        <form class="form-horizontal"
                                            action="proses_edit_file.php?id_ebook=<?php echo $id_ebook;?>"
                                            method="post">
                                            <div class="form-group" style="color:#800000">
                                                <label class="control-label col-sm-2 mb-2" for="id_ebook">
                                                    <h6>ID:</h6>
                                                </label>
                                                <fieldset disabled>
                                                    <div class="col-sm-12">
                                                        <input type="number" class="form-control mb-4" id="id_ebook"
                                                            name="id_ebook" value="<?php echo $baris['id_ebook'];?>">
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="form-group" style="color:#800000">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control mb-4" id="judul" name="judul"
                                                        value="<?php echo $baris['judul'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group" style="color:#800000">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control mb-4" id="penulis"
                                                        name="penulis" value="<?php echo $baris['penulis'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group" style="color:#800000">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control mb-4" id="penerbit"
                                                        name="penerbit" value="<?php echo $baris['penerbit'];?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12">
